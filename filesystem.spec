...
for lang in af am ar as ast az be bg bn bn_IN br bs ca ca@valencia cmn crh cs cy da de dz el en_AU en_CA en_GB eo es es_CO et eu fa fi fr fur fy ga gl gu ha he hi hr hu hy ia id ig is it ja ka kk kn ko ku ky lt lv mai mg mk ml mn mr ms nb nds ne nl nn nso oc or pa pl ps pt pt_BR ro ru rw si sk sl sq sr sr@latin sv ta te th tr ug uk ur uz vi wa xh yo zh_CN zh_HK zh_TW zu; do
